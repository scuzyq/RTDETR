...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='RT-DETR权重地址', help='initial weights path')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--source', type=str, default='替换你的视频地址', help='video file path')
